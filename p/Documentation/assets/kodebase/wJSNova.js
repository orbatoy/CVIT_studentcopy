...
(function($)
{
	...
	JSNova.prototype = 
	{
		...
		generate: function()
		{
			...
			$this.titleText = $('<input class="_wJSNova_sidebarTitleText">');
			...
			.append(
				...
				.append('<div class="_wJSNova_sidebarLabel">Project Title:</div>')
		...
		run: function()
		{
			...
			var titleText = '<title>' + this.titleText.val() + '</title>';

			var result = '<!DOCTYPE html><html><head>' + titleText + jQuery + jQueryUITheme + jQueryUI + '<link rel="stylesheet" href="../stylesheets/foundation.css"><link rel="stylesheet" href="../stylesheets/app.css"><style type="text/css">' + css + '</style></head><body>' + html + '<script type="text/javascript">' + js + '</script></body></html>';
